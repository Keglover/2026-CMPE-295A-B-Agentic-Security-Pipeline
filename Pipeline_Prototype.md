...
wget -q --show-progress -O runsc "$BASE_URL/runsc"
wget -q --show-progress -O runsc.sha512 "$BASE_URL/runsc.sha512"
wget -q --show-progress -O containerd-shim-runsc-v1 \
  "$BASE_URL/containerd-shim-runsc-v1"
wget -q --show-progress -O containerd-shim-runsc-v1.sha512 \
...
sudo install -m 0755 containerd-shim-runsc-v1 \
